                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    @if (is_null(Auth::user()->company))
                                        <a class="dropdown-item" href="{{ route('companyCreate') }}">
                                            {{ __('Add Company') }}
                                        </a>
                                    @else
                                        <a class="dropdown-item" href="{{ route('companyUpdate', ) }}">
                                            {{ __('Edit Company') }}
                                        </a>
                                        <hr>
                                        <a class="dropdown-item" href="{{ route('productCreate') }}">
                                            {{ __('Add Product') }}
                                        </a>
                                        <a class="dropdown-item" href="{{ route('showMyProducts') }}">
                                            {{ __('My Products') }}
                                        </a>
                                        <hr>
